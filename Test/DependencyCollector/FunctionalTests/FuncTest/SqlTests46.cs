namespace FuncTest
{
    ...
    public class SqlTests46
    {
        ...
        public static void MyClassInitialize(TestContext testContext)
        {
            ...
            LocalDb.CreateLocalDb("RDDTestDatabase", Aspx46TestWebApplication.AppFolder + "\\TestDatabase.sql");
        ...
        [DeploymentItem("..\\TestApps\\ASPX46\\App\\", Aspx46AppFolder)]
        public void TestRddForSyncSqlAspx46()
        {
            ...
            this.ExecuteSyncSqlTests(Aspx46TestWebApplication, 1, 1, AccessTimeMaxSqlCallToApmdbNormal);
        }
        ...
        public void TestStoredProcedureNameIsCollected()
        {
            ...
            Aspx46TestWebApplication.DoTest(
                     application =>
                     {
